            ...
            <Container>
                <ShareBox>
                    ...
                    <div>
                        ...
                        <button>
                            <img src="/img/write-article.png" alt="" />
                            <span>Write article</span>
                        </button>
                    </div>
                </ShareBox>
                <Content>
                    {props.loading && <img src={"/img/loading-circle.gif"} alt="" />}
                    {props.articles.length > 0 &&
                        props.articles.map((article, key) => (
                            <Article key={key}>
                                ...
                                <SocialCounts>
                                    <li>
                                        <button>
                                            <img src="/img/like-u.png" alt="" />
                                            <img src="/img/celebrate.png" alt="" />
                                            <span>75</span>
                                        </button>
                                    </li>
                                    <li>
                                ...
                                <SocialActions>
                                    <button>
                                        <img src="/img/facebook-like.png" alt="" />
                                        <span>Like</span>
                                    </button>
                                    <button>
                                    ...
                                    <button>
                                        <img src="/img/email-send.png" alt="" />
                                        <span>Send</span>
                                    </button>
                                </SocialActions>
                            </Article>
