...
const PostModal = (props) => {
    ...
    //     e.preventDefault();
    //     if (e.terget !== e.currentTarget.files) {
    //         // console.log('hello');
    //         return;
    //     }
                    ...
                    <Content>
                        ...
                        <SharedContent>
                            ...
                            <Editor>
                                ...
                                {assetArea === 'image' ? (
                                    <UploadImage>
                                        <input type="file" accept="image/gif, image/jpeg, image/png, image/jpg" name="image" id="file"
                                            style={{ display: "none" }}
                                    ...
                                    assetArea === 'media' && (
                                        <>
                                            <input type="text" placeholder="Input a video link" value={videoLink}
